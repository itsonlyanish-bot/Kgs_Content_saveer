...
API_ID = int(os.environ.get("API_ID", "34734487"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "648191684a5c39cbc2827ea0d82bc382")
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://luckykumar7004816_db_user:JDqDFZOt35wcxqkq@cluster0.urztudy.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
